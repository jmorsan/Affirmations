package ies.jms.affirmations.adapter
...
import ies.jms.affirmations.R
import ies.jms.affirmations.model.Affirmation
...
class ItemAdapter(val context : Context, val dataset:List<Affirmation>):RecyclerView.Adapter<ItemAdapter.ItemViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ItemViewHolder, position: Int) {
        ...
        holder.imageView.setImageResource(item.imageResourceld)
